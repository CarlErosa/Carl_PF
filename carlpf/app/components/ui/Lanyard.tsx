...
const photoTexture = '/assets/lanyard/photo.jpg';
...
export default function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  ...
  const photo = useTexture(photoTexture) as THREE.Texture;
